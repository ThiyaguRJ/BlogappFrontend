...
const Navbar = () => {
  ...
  <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
    ...
    <div className="hidden md:flex space-x-6 items-center">
      ...
      <Link to="/passwordreset" className="hover:text-gray-300">
        Password Reset
      </Link>

      <Link
        to={userRole === "reader" ? "#" : "/createpost"}
        onClick={userRole === "reader" ? (e) => e.preventDefault() : undefined}
        className={`${
          userRole === "reader"
  ...
  <div className="relative">
    {isOpen && (
      <div className="absolute top-full left-0 md:hidden bg-gray-800 px-4 pb-3 space-y-2 shadow w-full">
        ...
        <Link to="/passwordreset" className="block hover:text-gray-300">
          Password Reset
        </Link>
        ...
        <Link
          ...
          className={`${
            userRole === "reader"
              ? "block text-gray-300 pointer-events-none cursor-not-allowed"
